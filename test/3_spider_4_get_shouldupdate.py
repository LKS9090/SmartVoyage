...
# 配置
API_KEY = "5ef0a47e161a4ea997227322317eae83"  # 天气API的访问密钥
city_codes = {
    "北京": "101010100",
    "上海": "101020100",
    "广州": "101280101",
...
BASE_URL = "https://m7487r6ych.re.qweatherapi.com/v7/weather/30d"  # 天气预报API的基础URL，获取30天预报
...
db_config = {
    ...
    "database": "travel_rag",  # 数据库名称
    "charset": "utf8mb4"  # 字符编码，支持中文和特殊字符
}
